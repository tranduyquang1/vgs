    ...
    <div class="table-responsive">
        <table class="table table-striped jambo_table bulk_action">
            ...
            <tr class="headings">
                ...
                <th class="column-title">Banners Chuyên trang</th>
            ...
            @if (count($items) > 0)
                @foreach ($items as $key => $item)
                    ...
                    <tr>
                        ...
                        <td>
                            @livewire('select-banner-category-tournament', ['selected' => $item->banner_category_id, 'rowId' => $item->id], key($item->id))
                        </td>
                        
                        <td>
                            @livewire('status-button', ['model' => 'tournament_categories', 'status' => $item->status, 'rowId' =>
                            $item->id], key($item->id))
                        </td>

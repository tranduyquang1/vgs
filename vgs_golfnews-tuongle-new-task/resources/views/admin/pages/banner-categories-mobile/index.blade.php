...
@section('content')
    @php
        ...
        $listBannerCategory = BannersCategory::get();
        $listPage = [];
        if($listBannerCategory){
            foreach ($listBannerCategory as $key => $value) {
        ...
        $xhtmlSelectPage = Template::showSelectFilterCustom('category_id', $pageSelect, @$params['filter']['category_id'], false);
        $mobileSelect = ['default' => '-- Chọn loại banner --'] + config('zvn.banner_categories_mobile_position');
        $xhtmlSelectMobile = Template::showSelectFilterCustom('position', $mobileSelect, @$params['filter']['position'], false);
    @endphp
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="d-flex">
                        ...
                        <div>
                            <h5 class="text-center">Lọc theo banner</h5>
                            {!! $xhtmlSelectMobile !!}
                        </div>
                    </div>
                </div>

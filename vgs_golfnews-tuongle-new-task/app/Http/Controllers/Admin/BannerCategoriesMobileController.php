...
class BannerCategoriesMobileController extends Controller
{
    public $controllerName = 'banner-categories-mobile';
    public $pathViewController = 'admin.pages.banner-categories-mobile.';
    protected $model;
    protected $params = [];
    ...
    public function ListCategoriesIndex(Request $request){
        ...
        $this->params['filter']['is_mobile'] = 1;

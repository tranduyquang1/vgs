...
class BannerCategoriesPcController extends Controller
{
    public $controllerName = 'banner-categories-pc';
    public $pathViewController = 'admin.pages.banner-categories-pc.';
    protected $model;
    protected $params = [];
    ...
    public function ListCategoriesIndex(Request $request){
        ...
        $this->params['filter']['is_mobile'] = 0;

...
class TournamentLive extends AdminModel
{
    // use NodeTrait;
    protected $table = 'tournament_live';
    protected $searchAccepted = ['name', 'id'];
    protected $fieldSearchAccepted = [
        'id',
        'name'
    ];
    protected $fillable = ['id','name','status','tournament_categories_id','image','content','url_key','type'];

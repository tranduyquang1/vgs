...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            @php
                $menus = config('navigation.'.$userInfo['level']);
            @endphp
            @foreach($menus as $menu)
                ...
                @else
                    <li @if(in_array($actionName, ['form', 'view']) && in_array($controllerName, $menu['arr_controller'])) class="current-page"@endif>
                        ...
                        <ul class="nav child_menu" @if(in_array($actionName, ['form', 'view']) && in_array($controllerName, $menu['arr_controller'])) style="display: block" @endif>

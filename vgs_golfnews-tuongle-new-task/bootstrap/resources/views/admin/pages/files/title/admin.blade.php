<tr>
    ...
    <td colspan="3" class="text-center" style="vertical-align: middle;">Tìm kiếm</td>
    ...
    <td><input type="text" name="search[art_theo_kieu_moi]" class="form-control search-filter" data-sheet="{{ $sheet->id }}"></td>
    ...
    <td><input type="text" name="search[revision_theo_kieu_moi]" class="form-control search-filter"></td>
    <td><input type="text" name="search[code_nm]" class="form-control search-filter" data-sheet="{{ $sheet->id }}"></td>
...
<tr class="headings">
    ...
    <th class="column-title" style="min-width: 60px">Xóa</th>
    ...
    <th class="column-title" style="min-width: 120px">ART</th>
    <th class="column-title" style="min-width: 120px">ART theo thiết kế mới R02</th>
    <th class="column-title" style="min-width: 120px">Tên mã hàng</th>
    <th class="column-title" style="min-width: 120px">Revision</th>
    <th class="column-title" style="min-width: 120px">Revision theo thiết kế mới R02</th>
    <th class="column-title" style="min-width: 120px">Code NM</th>
